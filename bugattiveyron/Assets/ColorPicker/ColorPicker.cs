...
public class ColorPicker : MonoBehaviour {
	...
	void Start()
	{
		...
		txColorDisplay = new Texture2D(10, 10, TextureFormat.ARGB32, false);
		if(receiver)
		{
	...
	public void _DrawGUI () 
	{
		...
		//GUI.DrawTexture(new Rect(startPos.x + sizeCurr + 10, startPos.y, 80, 60), txColorDisplay);

		if(mState == ESTATE.Showed)
		{/*
			txtR = GUI.TextField(new Rect(startPos.x + sizeCurr + 10, startPos.y + 90, 160, 80), txtR, 12);
			txtG = GUI.TextField(new Rect(startPos.x + sizeCurr + 10, startPos.y + 180, 160, 80), txtG, 12);
			txtB = GUI.TextField(new Rect(startPos.x + sizeCurr + 10, startPos.y + 270, 160, 80), txtB, 12);
			txtA = GUI.TextField(new Rect(startPos.x + sizeCurr + 10, startPos.y + 360, 160, 80), txtA, 12);
			valR = GUI.HorizontalSlider(new Rect(startPos.x + sizeCurr + 170, startPos.y + 95, 240, 80), valR, 0.0f, 1.0f);
			valG = GUI.HorizontalSlider(new Rect(startPos.x + sizeCurr + 170, startPos.y + 185, 240, 80), valG, 0.0f, 1.0f);
			valB = GUI.HorizontalSlider(new Rect(startPos.x + sizeCurr + 170, startPos.y + 275, 240, 80), valB, 0.0f, 1.0f);
			valA = GUI.HorizontalSlider(new Rect(startPos.x + sizeCurr + 170, startPos.y + 365, 240, 80), valA, 0.0f, 1.0f);*/
